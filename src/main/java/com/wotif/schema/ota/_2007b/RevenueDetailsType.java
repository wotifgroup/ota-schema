...
public class RevenueDetailsType {
    ...
    protected List<RevenueDetailType> revenueDetails;
     ...
     * This is why there is not a <CODE>set</CODE> method for the revenueDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRevenueDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RevenueDetailType> getRevenueDetails() {
        if (revenueDetails == null) {
            revenueDetails = new ArrayList<RevenueDetailType>();
        }
