...
public class StatisticType {
    ...
    public static class StatisticApplicationSets {
        ...
        protected List<StatisticApplicationSetType> statisticApplicationSets;
         ...
         * This is why there is not a <CODE>set</CODE> method for the statisticApplicationSets property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getStatisticApplicationSets().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<StatisticApplicationSetType> getStatisticApplicationSets() {
            if (statisticApplicationSets == null) {
                statisticApplicationSets = new ArrayList<StatisticApplicationSetType>();
            }
