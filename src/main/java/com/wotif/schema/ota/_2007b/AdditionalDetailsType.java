...
public class AdditionalDetailsType {
    ...
    protected List<AdditionalDetailType> additionalDetails;
     ...
     * 
     */
    public List<AdditionalDetailType> getAdditionalDetails() {
        if (additionalDetails == null) {
            additionalDetails = new ArrayList<AdditionalDetailType>();
        }
