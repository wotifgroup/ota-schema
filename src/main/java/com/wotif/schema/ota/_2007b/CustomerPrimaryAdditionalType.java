...
public class CustomerPrimaryAdditionalType {
    ...
    protected List<CustomerPrimaryAdditionalType.Additional> additionals;
     ...
     * 
     */
    public List<CustomerPrimaryAdditionalType.Additional> getAdditionals() {
        if (additionals == null) {
            additionals = new ArrayList<CustomerPrimaryAdditionalType.Additional>();
        }
