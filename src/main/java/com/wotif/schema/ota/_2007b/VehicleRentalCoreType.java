...
@XmlSeeAlso({
    com.wotif.schema.ota._2007b.VehicleRentalTransactionType.PickUpReturnDetails.class
})
public class VehicleRentalCoreType {

    @XmlElement(name = "PickUpLocation")
    protected List<VehicleRentalCoreType.PickUpLocation> pickUpLocations;
     ...
     * This is why there is not a <CODE>set</CODE> method for the pickUpLocations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPickUpLocations().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VehicleRentalCoreType.PickUpLocation> getPickUpLocations() {
        if (pickUpLocations == null) {
            pickUpLocations = new ArrayList<VehicleRentalCoreType.PickUpLocation>();
        }
