...
public class AcceptedPaymentsType {
    ...
    protected List<PaymentFormType> acceptedPayments;
     ...
     * This is why there is not a <CODE>set</CODE> method for the acceptedPayments property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAcceptedPayments().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PaymentFormType> getAcceptedPayments() {
        if (acceptedPayments == null) {
            acceptedPayments = new ArrayList<PaymentFormType>();
        }
