...
public class ItemSearchCriterionType {
    ...
    protected List<ItemSearchCriterionType.RefPoint> refPoints;
     ...
     * 
     */
    public List<ItemSearchCriterionType.RefPoint> getRefPoints() {
        if (refPoints == null) {
            refPoints = new ArrayList<ItemSearchCriterionType.RefPoint>();
        }
