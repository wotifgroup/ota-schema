...
public class OTAHotelAvailNotifRQ {
    ...
    public static class AvailStatusMessages {
        ...
        protected List<AvailStatusMessageType> availStatusMessages;
         ...
         * 
         */
        public List<AvailStatusMessageType> getAvailStatusMessages() {
            if (availStatusMessages == null) {
                availStatusMessages = new ArrayList<AvailStatusMessageType>();
            }
