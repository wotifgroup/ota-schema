...
public class TravelerInformationType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the passengerTypeQuantities property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPassengerTypeQuantities().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PassengerTypeQuantityType> getPassengerTypeQuantities() {
        if (passengerTypeQuantities == null) {
            passengerTypeQuantities = new ArrayList<PassengerTypeQuantityType>();
        }
